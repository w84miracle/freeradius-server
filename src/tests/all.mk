SUBMAKEFILES := rbmonkey.mk eapol_test/all.mk dict/all.mk unit_test_attribute/all.mk map/all.mk xlat/all.mk keywords/all.mk util/all.mk auth/all.mk modules/all.mk daemon/all.mk
